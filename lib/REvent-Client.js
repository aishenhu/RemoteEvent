 ...
 */
REventClient.prototype.rpc = function(rpcRoute, param, callback){
    ...
    this.notifyObservers(rpcRoute, param);
}
...
REventClient.prototype.registerRpc = function(rpcRoute, handler){
    ...
    this.addObserver(rpcRoute, function(rpcParam){
        ...
        var id = rpcParam._rpc_;
        delete rpcParam._rpc_;
